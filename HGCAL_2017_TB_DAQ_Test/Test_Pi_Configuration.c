...
int main(){
	...
	char buffer[80];
	char fname [160];
	char dirname[] = "/home/pi/HGCAL_2017_TB_DAQ_Test/";//Change
...
//////////////////Testing//////////////////////////////
	int iii;
	hexbd = 1;
	for(iii = 0; iii < 10; iii = iii + 1){
		spi_write_local_fifo(hexbd, CMD_LOOPBACK | iii);
		printf("Iter %i wrote %02x \n", iii, CMD_LOOPBACK | iii);
		res = spi_read_local_fifo(hexbd);
        	printf("Iter %i Read Back %02x \n", iii,  res & 0xff);	
	}
////////////////////////////////////////////////////////
*/
