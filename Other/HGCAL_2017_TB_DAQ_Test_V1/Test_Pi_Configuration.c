...
int main(int argc, char *argv[]){
	...
	char buffer[80];
	char fname [160];
	char dirname[] = "/home/pi/HGCAL_2017_TB_DAQ_Test_V1/data/";//Change
...
///////////////////////////////////////////////////////////////////////////////////////////////	
	...
	init_SPI();
	hexbd = 0;//Current work with one hexaboard, generalize later

// spi_reset_firmware(hexbd);

// check waveform on scope.
if (0) {
 while (1) {
   res = spi_send_command(0, CMD_LOOPBACK | 2);
   res = spi_send_command(1, CMD_LOOPBACK | 2);
   res = spi_send_command(2, CMD_LOOPBACK | 2);
//   res = spi_send_command(3, CMD_LOOPBACK | 2);
//   res = spi_send_command(4, CMD_LOOPBACK | 2);
//   res = spi_send_command(5, CMD_LOOPBACK | 2);
//   res = spi_send_command(6, CMD_LOOPBACK | 2);
//   res = spi_send_command(7, CMD_LOOPBACK | 2);
 }
}
